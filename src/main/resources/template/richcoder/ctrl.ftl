...
public class ${tableInfo.className}Ctrl {
    ...
    @PostMapping("/page")
    public Page<${tableInfo.className}DTO> page( @RequestBody ${tableInfo.className}PageableDTO dto){
        Page<${tableInfo.className}DTO> page = ${tableInfo.shortStartClassName}Service.page(dto);
        return page;
    }
    ...
    @PostMapping("/add")
    public Long add(@Validated(${tableInfo.className}ModifyDTO.Create.class) @RequestBody ${tableInfo.className}ModifyDTO dto){
    ...
    @PostMapping("/update")
    public void update(@Validated(${tableInfo.className}ModifyDTO.Update.class) @RequestBody ${tableInfo.className}ModifyDTO dto){
        ${tableInfo.className} data = new ${tableInfo.className}();
        BeanUtils.copyProperties(dto, data);
