package com.richcoder.code.generate.db.code.conf;
...
public class GenerateConfig {
	...
	public GenerateConfig(String templateBasePath, List<TableInfo> tableInfos, Set<String> skipTables,
		...
		this.pageDtoPackageName = pageDtoPackageName == null ? this.pageDtoPackageName : pageDtoPackageName;
		this.modifyDtoPackageName = modifyDtoPackageName == null ? this.modifyDtoPackageName : modifyDtoPackageName;
		this.daoPackageName = daoPackageName == null ? this.daoPackageName : daoPackageName;
		this.daoImplPackageName = daoImplPackageName == null ? this.daoImplPackageName : daoImplPackageName;
		this.servicePackageName = servicePackageName == null ? this.servicePackageName : servicePackageName;
		this.serviceImplPackageName = serviceImplPackageName == null ? this.serviceImplPackageName : serviceImplPackageName;
		this.controllerPackageName = controllerPackageName == null ? this.controllerPackageName : controllerPackageName;
